...
void qmp_input_send_event(int64_t console, InputEventList *events, Error **errp);
int qmp_marshal_input_input_send_event(Monitor *mon, const QDict *qdict, QObject **ret);
